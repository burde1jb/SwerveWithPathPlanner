...
public class RobotConstants {
    ...
    public final static double dumpArmValue = 0.029;
    public final static double ampArmValue = 0.938;
    public final static double groundArmValue = 0.235;
    ...
    public final static double wristrangeOffset = 0.03;
    ...
    public final static double dumpWristValue = 0.62;
    ...
    public final static double groundWristValue = 0.594;
